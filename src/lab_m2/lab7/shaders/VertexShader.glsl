...
void main()
{
    ...
    mat4 BoneTransform = bones_matrices[BoneIDs[0]] * Weights[0];
    BoneTransform += bones_matrices[BoneIDs[1]] * Weights[1];
    BoneTransform += bones_matrices[BoneIDs[2]] * Weights[2];
    BoneTransform += bones_matrices[BoneIDs[3]] * Weights[3];
